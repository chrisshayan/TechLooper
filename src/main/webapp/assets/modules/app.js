...
var techlooper = angular.module("Techlooper", [
  "pascalprecht.translate", "ngResource", "ngCookies", "ngRoute", 'ngSanitize', 'ui.select',
  "Bubble", "Pie", "Home", "Header", "Footer", "Common", "Chart", "Jobs", "SearchForm"
]);
...
techlooper.filter('propsFilter', function () {
