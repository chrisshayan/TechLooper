...
public class VietnamworksJobImporter {
    ...
    public void indexJobFromVietnamworks() throws Exception {
        ...
        try {
            int numberOfTopPriorityJobs = jobAggregatorService.importVietnamworksJob(JOB_TYPE_TOP_PRIORITY);
            int numberOfNormalJobs = jobAggregatorService.importVietnamworksJob(JOB_TYPE_NORMAL);
