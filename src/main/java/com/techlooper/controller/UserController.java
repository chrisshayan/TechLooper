...
public class UserController {
    ...
    public JobSeekerDashBoardInfo getJobSeekerDashboard(HttpServletRequest request) {
        String registrantEmail = request.getRemoteUser();
        JobSeekerDashBoardInfo jobSeekerDashBoardInfo = new JobSeekerDashBoardInfo();
        jobSeekerDashBoardInfo.setEmail(registrantEmail);
        jobSeekerDashBoardInfo.setChallenges(challengeRegistrantService.getChallengeDashBoardInfo(registrantEmail));
