...
public class SocialController {
    ...
    public void registerVnwUser(@RequestParam String code, HttpServletResponse response) throws IOException {
        ...
        ChallengeRegistrantEntity challengeRegistrantEntity =
                new ChallengeRegistrantEntity(userProfile.getEmail(), userProfile.getFirstName(), userProfile.getLastName());
        challengeRegistrantRepository.save(challengeRegistrantEntity);

        Base64.Encoder encoder = Base64.getEncoder();
        response.sendRedirect("/#/?registerVnwUser=" + encoder.encodeToString(userProfile.getEmail().getBytes()));
    }
