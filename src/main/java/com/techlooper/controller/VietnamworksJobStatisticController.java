...
public class VietnamworksJobStatisticController {
   ...
   public void countProjectManagerJobs() {
      messagingTemplate.convertAndSend("/topic/technical-job/project_manager",
            new JobStatisticResponse.Builder().withCount(vietnamWorksJobStatisticService.countProjectManagerJobs()).build());
   }
