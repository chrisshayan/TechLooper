...
public class SkillStatisticResponse {
    ...
    public static class Builder {
        ...
        public Builder withJobTerm(TechnicalTerm jobTerm) {
    ...
    public TechnicalTerm getJobTerm() {
        return jobTerm;
    }

    public void setJobTerm(TechnicalTerm jobTerm) {
