...
public class GoogleCalendarServiceImpl implements GoogleCalendarService {
  ...
  public WebinarInfoDto createWebinarInfo(WebinarInfoDto webinarInfoDto) throws IOException {
    ...
    org.joda.time.DateTime startDate = dateTimeFormatter.parseDateTime(webinarInfoDto.getStateDate());
