                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 14px;">
                                                Bạn vừa mới ứng tuyển vào tin đăng tuyển như sau :
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height:20px; line-height: 20px;" width="100%">
                                                ...
                                                <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                                                    <tr>
                                                        <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                                                            <a href="${webBaseUrl}#/freelancer/project-detail/${projectAlias}-${projectId}-id?utm_source=jobseekerapplication&utm_medium=viewprojectbtn&utm_campaign=freelancer&lang=vi" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">Xem Ngay</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
