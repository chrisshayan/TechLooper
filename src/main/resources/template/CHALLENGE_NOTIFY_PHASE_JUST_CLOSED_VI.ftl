                ...
                <td style="font-family: Arial, sans-serif; padding: 20px; margin: 0 auto; " class="content-padding">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <#elseif currentPhase == "FINAL">
                      ...
                      <td align="left" style="font-size: 14px;">
                          Giai đoạn <strong>${localizedOldPhase}</strong> của thử thách <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?utm_source=remindphaseclose&utm_medium=clickchallenge&utm_campaign=onlinecontest" style="color:#337ab7" target="_blank"><strong>${challenge.challengeName}</strong></a> vừa mới kết thúc.
                      <#if oldPhase != "FINAL">
                          Tiến độ hiện thời của thử thách là <strong>${localizedCurrentPhase}</strong> với <strong>${currentPhaseRegistrants}</strong> đang tham gia.
                      <#else>
                          Bây giờ là giai đoạn chấm điểm sản phẩm cho các thí sinh và chọn ra người chiến thắng.
                      </#if>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left" style="font-size: 14px;">
                        <#if oldPhase != "FINAL">
                            Bạn có muốn quay lại ${localizedOldPhase} để lựa chọn thêm thí sinh tham gia?
                        <#else>
                            Bạn có muốn đánh giá các thí sinh ngay bây giờ?
                        </#if>
                      </td>
                    </tr>
                    <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;" width="100%" border="0">
                                    <tbody><tr>
                                        <td style="text-align: right;padding-right: 20px;">
                                            <h2 style="font-family:Arial, sans-serif;font-size: 18px;margin: 0 0 10px 0 ; color: #424242;font-weight: normal;">3. Chọn ra người chiến thắng cho mỗi giải thưởng:</h2>
                                            <p style="font-family:Arial, sans-serif;margin: 0 0 25px 0; font-size:14px; color:#666;line-height: 18px;text-align: right;">
                                                Chọn người chiến thẳng bằng cách đánh dấu vào checkbox tương ứng.
                                            </p>
                                        </td>
