                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    <tr>
                      <td align="center" style="padding: 10px 0 5px 0">
                        <h2 style="font-size: 20px; font-weight: 500; padding:0; margin: 0;">Đăng Tin Thử Thách</h2>
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <#if challengePhase == "IDEA">
                              Chỉ <strong>còn ${numberOfDays} ngày để đề xuất ý tưởng</strong> cho thử thách dưới đây:
                          <#elseif challengePhase == "UIUX">
                              Chỉ <strong>còn ${numberOfDays} ngày để gửi UI/UX</strong> cho thử thách dưới đây:
                          <#elseif challengePhase == "PROTOTYPE">
                              Chỉ <strong>còn ${numberOfDays} ngày để gửi Prototype</strong> cho thử thách dưới đây:
                          <#elseif challengePhase == "FINAL">
                              Chỉ <strong>còn ${numberOfDays} ngày để gửi Sản Phẩm Cuối</strong> cho thử thách dưới đây:
                          <#else>
                              Chỉ <strong>còn ${numberOfDays} ngày để gửi ${challengePhase}</strong> cho thử thách dưới đây:
                          </#if>
                          </td>
                      </tr>
                    <tr>
                        ...
                        <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                          <tr>
                            <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                              <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?utm_source=remindsubmission&utm_medium=viewchallengebtn&utm_campaign=onlinecontest" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">Xem Thử Thách</a>
                            </td>
                          </tr>
                        </table>
                      </td>
