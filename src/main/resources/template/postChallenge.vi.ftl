                        ...
                        <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                          <tr>
                            <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                              <a href="${webBaseUrl}#/contest-detail/${challengeName}-${challengeId}?utm_source=challengepublishemail&utm_medium=viewchallengebtn&utm_campaign=topcoder" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">Xem Thử Thách</a>
                            </td>
                          </tr>
                        </table>
                      </td>
