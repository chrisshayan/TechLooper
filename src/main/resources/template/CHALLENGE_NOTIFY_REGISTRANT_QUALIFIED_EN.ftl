                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Hi ${challengeRegistrant.registrantFirstName},</p>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">You have just qualified to next phase ${localizedCurrentPhase} of this challenge <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?utm_source=qualifycontestant&utm_medium=clickchallenge&utm_campaign=onlinecontest" style="font-size: 14px; font-weight: 600; color: #277cbd; text-decoration: none" target="_blank">${challengeName}</a>. Congratulations! Always keep up your good work!</p>
                      </td>
                    </tr>
                    <tr>
