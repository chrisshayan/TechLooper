                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    <tr>
                      <td align="center" style="padding: 10px 0 5px 0">
                        <h2 style="font-size: 20px; font-weight: 500; padding:0; margin: 0;">Thông Báo Việc Làm</h2>
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                        <p style="font-size: 12px; font-style: italic; line-height: 18px">Truy cập vào hàng ngàn công việc sẵn có từ những website tuyển dụng xung quanh bạn</p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td align="left" width="100%" style="font-size: 14px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                          ...
                          <tr>
                            <td align="left" style="pcolor: #892890">
                              Từ
                                <#if job.crawlSource??>${job.crawlSource}</#if>
                            </td>
                          </tr>
                        </table>
                      </td>
                              ...
                              <tr>
                                  <td width="100%" align="center">
                                      <a href="${webBaseUrl}#/topics?utm_source=jobalertemail&utm_medium=viewmoretopics&utm_campaign=techlooperjobhub"
                                         target="_blank"
                                         style="font-family: Arial, sans-serif; font-size: 14px;font-weight: 500; text-decoration: none; color:#277cbd">Xem Thêm Chủ Đề</a>
                                  </td>
                              </tr>
                              <tr>
                                  <td width="100%" height="20"><img height="1" width="1"
