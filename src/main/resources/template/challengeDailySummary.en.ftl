                          ...
                          <tr>
                            <td align="left" valign="top">
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto;background-color:#257abb">
                                <tr>
                                  <td style="color:#fff; font-size: 16px; font-weight: 500;">See how your challenge grows in last 24 hours</td>
                                </tr>
                              </table>
                          ...
                          <tr>
                            <td align="left" valign="top">
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto;background-color:#89288a">
                                <tr>
                                  <td style="color:#fff; font-size: 16px; font-weight: 500;">This is the time of boost your challenge?</td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto">
                                <tr>
                                ...
                                <tr>
                                  <td style="font-size: 14px;" align="left">If you want to receive more registrations, reply to this email to boost your contest post. </td>
                                </tr>
                                <tr>
                                  <td style="height:5px; line-height: 5px;">
                                    <img height="5px" width="1" src="http://images.vietnamworks.com/x.gif" style="display:block; border: 0px" />
                                  ...
                                  <td align="left" valign="top">
                                    ...
                                    <table width="45%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto; float: left" class="fullWidth">
                                      <tr>
                                        ...
                                        <td style="font-size: 14px;">
                                          <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=userLogin&a=registrants&filterType=challengeSubmission&fromDate=${yesterdayDateTime}&utm_source=dailysummary&utm_medium=accept&utm_campaign=onlinecontest" target="_blank"
