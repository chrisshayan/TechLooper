                            ...
                            <tr>
                                <td style="font-family: Arial, sans-serif; padding: 20px; margin: 0 auto; " class="content-padding">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                                        ...
                                        <tr>
                                            <td align="left" style="margin: 0; padding: 0">
                                                <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Bạn vừa tạo thành công thử thách <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?utm_source=updatecriteria&utm_medium=clickchallenge&utm_campaign=onlinecontest" style="font-size: 14px; font-weight: 600; color: #277cbd; text-decoration: none" target="_blank">${challengeName}</a>. <br/>Bạn có muốn thiết lập tiêu chí đánh giá cho thử thách ngay bây giờ?</p>
                                            </td>
                                        </tr>
                                        <tr>
