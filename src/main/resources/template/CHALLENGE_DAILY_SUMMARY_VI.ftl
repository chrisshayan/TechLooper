                                                                    ...
                                                                    <td width="100%">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="float:left;border: 1px solid #84c1ef;">
                                                                            ...
                                                                            <#list latestRegistrants as latestRegistrant>
                                                                                <tr>
                                                                                    <td style="text-align: center; padding: 10px 5px;border-top: 1px solid #84c1ef;" width="30px">${latestRegistrant_index + 1}</td>
                                                                                    <td style="padding: 10px 5px; border-left: 1px solid #84c1ef;border-top: 1px solid #84c1ef;">${latestRegistrant.registrantFirstName} ${latestRegistrant.registrantLastName}</td>
                                                                                </tr>
                                                                            </#list>
                                                                        </table>
                                                                    </td>
                                        ...
                                        <tr>
                                            <td align="left" style="margin: 0; padding: 0">
                                                ...
                                                <#if REGISTRATIONSubmissions?has_content>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            Bạn đã nhận <strong>${numberOfSubmissions}</strong> bài nộp mới cho giai đoạn <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&toPhase=REGISTRATION&utm_source=dailysummary&utm_medium=phasename&utm_campaign=onlinecontest" style="color: #277cbd; text-decoration: none; font-weight: 600;text-transform: uppercase;">Đăng Ký</a>.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:5px; line-height: 5px;" width="100%">
                                                ...
                                                <#if IDEASubmissions?has_content>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            Bạn đã nhận <strong>${numberOfSubmissions}</strong> bài nộp mới cho giai đoạn <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&toPhase=IDEA&utm_source=dailysummary&utm_medium=phasename&utm_campaign=onlinecontest" style="color: #277cbd; text-decoration: none; font-weight: 600;text-transform: uppercase;">Ý Tưởng</a>.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:5px; line-height: 5px;" width="100%">
                                                ...
                                                <#if UIUXSubmissions?has_content>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            Bạn đã nhận <strong>${numberOfSubmissions}</strong> bài nộp mới cho giai đoạn <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&toPhase=UIUX&utm_source=dailysummary&utm_medium=phasename&utm_campaign=onlinecontest" style="color: #277cbd; text-decoration: none; font-weight: 600;text-transform: uppercase;">UI/UX</a>.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:5px; line-height: 5px;" width="100%">
                                                ...
                                                <#if PROTOTYPESubmissions?has_content>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            Bạn đã nhận <strong>${numberOfSubmissions}</strong> bài nộp mới cho giai đoạn <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&toPhase=PROTOTYPE&utm_source=dailysummary&utm_medium=phasename&utm_campaign=onlinecontest" style="color: #277cbd; text-decoration: none; font-weight: 600;text-transform: uppercase;">Prototype</a>.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:5px; line-height: 5px;" width="100%">
                                                ...
                                                <#if FINALSubmissions?has_content>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            Bạn đã nhận <strong>${numberOfSubmissions}</strong> bài nộp mới cho giai đoạn <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&toPhase=FINAL&utm_source=dailysummary&utm_medium=phasename&utm_campaign=onlinecontest" style="color: #277cbd; text-decoration: none; font-weight: 600;text-transform: uppercase;">Sản Phẩm Cuối</a>.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:5px; line-height: 5px;" width="100%">
