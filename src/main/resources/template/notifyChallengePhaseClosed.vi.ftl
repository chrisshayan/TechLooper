              ...
              <tr>
                <td style="font-family: Arial, sans-serif; padding: 20px; margin: 0 auto; " class="content-padding">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <tr>
                      <td align="left" style="font-size: 14px;">
                        Giai đoạn <strong>[phase-name]</strong> của thử thách <a href="" style="color:#337ab7" target="_blank"><strong>[challenge-name]</strong></a> vừa mới kết thúc. Tiến độ hiện thời của thử thách là <strong>[next-phase-name]</strong> với <strong>[registrant-number-of-next-phase]</strong> đang tham gia.
                      </td>
                    </tr>
                    <tr>
                      <td style="height:10px; line-height: 10px;" width="100%">
                    ...
                    <tr>
                      <td align="left" style="font-size: 14px;">
                        Bạn có muốn quay lại [phase-name] để lựa chọn thêm thí sinh tham gia?
                      </td>
                    </tr>
                    <tr>
                      <td style="height:30px; line-height: 30px;" width="100%">
