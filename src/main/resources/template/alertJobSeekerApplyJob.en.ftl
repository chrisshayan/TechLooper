...
<table style="margin:0 auto; background: #eee; color: #000" align="center" width="100%" class="deviceWidth">
  <tr>
              ...
              <table style="border-collapse: collapse; background:#eee; margin:0 auto" cellpadding="0" cellspacing="0" align="center" border="0" class="deviceWidth" width="100%">
                <tr>
                  <td align="left" style="padding:10px" class="logo">
                    <a href="http://www.techlooper.com/#/?lang=en&utm_source=jobseekerapplication&utm_medium=techlooperlogo&utm_campaign=freelancer" style="border:none; outline:none" target="_blank">
                  ...
                  <td style="padding:10px" align="right" class="logo">
                    <a href="http://www.vietnamworks.com/?utm_source=jobseekerapplication&utm_medium=vietnamworkslogo&utm_campaign=freelancer" style="border:none; outline:none" target="_blank">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    <tr>
                      <td align="center" style="padding: 10px 0 5px 0">
                        <h2 style="font-size: 20px; font-weight: 500; padding:0; margin: 0;">Freelancer Project</h2>
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                    ...
                    <tr>
                      <td align="left" style="font-size: 14px;">
                        You has just applied to a job post as follows
                      </td>
                    </tr>
                    <tr>
                      <td style="height:20px; line-height: 20px;" width="100%">
                        ...
                        <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                          <tr>
                            <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                              <a href="${webBaseUrl}#/freelancer/project-detail/${projectAlias}-${projectId}-id?utm_source=jobseekerapplication&utm_medium=viewprojectbtn&utm_campaign=freelancer" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">View Job Post</a>
                            </td>
                          </tr>
                        </table>
                      </td>
