                            ...
                            <table style="border-collapse: collapse; background:#eee; margin:0 auto" cellpadding="0" cellspacing="0" align="center" border="0" class="deviceWidth" width="100%">
                                <tr>
                                    <td align="left" style="padding:10px" class="logo">
                                        <a href="${webBaseUrl}#/home?utm_source=webinaremail&utm_medium=techlooperlogo&utm_campaign=webinar" style="border:none; outline:none" target="_blank">
                                    ...
                                    <td style="padding:10px" align="right" class="logo">
                                        <a href="http://www.vietnamworks.com/?utm_source=webinaremail&utm_medium=vietnamworkslogo&utm_campaign=webinar" style="border:none; outline:none" target="_blank">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                                        <tr>
                                            <td align="center" style="padding: 10px 0 5px 0">
                                                <h2 style="font-size: 20px; font-weight: 500; padding:0; margin: 0;">Webinar</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                                <p style="font-size: 12px; font-style: italic; line-height: 18px">Hãy cùng Gặp Gỡ và Giao Lưu thông qua các Sự Kiện Trực Tuyến</p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="left" width="100%" style="font-size: 14px;">
                                                Có thành viên mới <strong style="font-size: 14px;"><#if attendee.firstName??>${attendee.firstName}</#if> <#if attendee.lastName??>${attendee.lastName}</#if></strong>,
                                                <a href="mailto:<#if attendee.email??>${attendee.email}</#if>" style="color: #277cbd">
                                                <#if attendee.email??>${attendee.email}</#if>
                                                </a> vừa mới tham dự vào sự kiện của bạn.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height:20px; line-height: 20px;" width="100%">
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="left" style="margin: 0 auto; color:#000000" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="left" width="55%" style="font-size: 14px; padding-left: 15px" valign="top">
                                                            Bạn có thể truy cập xem thông tin sự kiện tại đây
                                                        </td>
                                                ...
                                                <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                                                    <tr>
                                                        <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                                                            <a href="${webBaseUrl}#/event-detail/${webinarNameAlias}?utm_source=webinaremail&utm_medium=vieweventbtn&utm_campaign=webinar" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">Xem Ngay</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
