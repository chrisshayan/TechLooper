                            ...
                            <tr>
                                <td style="font-family: Arial, sans-serif; padding: 20px; margin: 0 auto; " class="content-padding">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="background-color: #edf7ff; margin: 0 auto; float:left" class="fullWidth">
                                                    <tr>
                                                                        ...
                                                                        <td align="left" valign="top">
                                                                            ...
                                                                            <table width="45%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto; float: left" class="fullWidth">
                                                                                <tr>
                                                                                  ...
                                                                                  <td style="font-size: 14px;">
                                                                                    <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?action=employerLogin&a=registrants&filterType=challengeSubmission&fromDate=${yesterdayDateTime}&utm_source=dailysummary&utm_medium=accept&utm_campaign=onlinecontest" target="_blank" style="font-family: Arial, sans-serif; font-size: 14px; color: #277cbd; text-decoration: none; display: block; width: 100%">Đi Tiếp</a>
                                                                                  </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
