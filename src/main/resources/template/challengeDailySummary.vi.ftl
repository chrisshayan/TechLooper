...
<table style="margin:0 auto; background: #eee; color: #555" align="center" width="100%" class="deviceWidth">
  <tr>
    <td class="box-padding" style="margin: 0 auto; padding:5px;">
      <!--Content -->
      <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;background-color: #FFFFFF;border-top: 0;border-bottom: 0; margin:0 auto 20px;" align="center" class="template-content">
        <tbody>
        <tr>
          <td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Xin chào <strong style="color:#000; font-size: 14px; font-weight: 700;">thu.hoang@navigosgroup.com</strong>,</p>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Dưới đây là báo cáo hằng ngày cho thử thách <a href="" style="font-size: 14px; font-weight: 600; color: #277cbd; text-decoration: none" target="_blank">Challenge Name</a></p>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left">
                        <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="background-color: #edf7ff; margin: 0 auto; float:left; height:150px" class="fullWidth">
                          <tr>
                            <td align="left" valign="top">
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto;background-color:#257abb">
                                <tr>
                                  <td style="color:#fff; font-size: 16px; font-weight: 500;">Thử thách của bạn mở rộng như thế nào trong 24 giờ qua</td>
                                </tr>
                              </table>
                              ...
                              <table width="200px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                                <tr>
                                  <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                                    <a href="#" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: block; width: 100%">Gửi Email Cho Tất Cả</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                    ...
                    <tr>
                      <td align="left">
                        <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="background-color: #feeafe; margin: 0 auto; float:left;" class="fullWidth">
                          <tr>
                            <td align="left" valign="top">
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto;background-color:#89288a">
                                <tr>
                                  <td style="color:#fff; font-size: 16px; font-weight: 500;">Đây có phải là thời điểm để quảng bá cho thử thách của bạn?</td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto">
                                <tr>
                                ...
                                <tr>
                                  <td style="font-size: 14px;" align="left">Nếu bạn muốn nhận thêm nhiều lượt đăng ký, trả lời email này để chúng tôi có thể hỗ trợ bạn.</td>
                                </tr>
                                <tr>
                                  <td style="height:5px; line-height: 5px;">
                                    <img height="5px" width="1" src="http://images.vietnamworks.com/x.gif" style="display:block; border: 0px" />
                          ...
                          <tr>
                            <td align="left" valign="top">
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto;background-color:#a6a8a6">
                                <tr>
                                  <td style="color:#fff; font-size: 16px; font-weight: 500;">Khám phá số lượng bài nộp mới vào thử thách</td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellspacing="5" cellpadding="0" align="center" style="margin: 0 auto">
                                <tr>
                                ...
                                <tr>
                                  <td style="font-size: 14px; margin: 0; padding: 0; text-align:left">
                                    Bạn nhận được thêm 10 bài nộp mới cho giai đoạn "<strong style="color:#000; font-size: 14px; font-weight: 600;">Ý Tưởng</strong>" trong vòng 24 giờ qua:
                                  </td>
                                </tr>
                                <tr>
                                    ...
                                    <table width="20%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto; float: left" class="fullWidth">
                                      <tr>
                                        <td style="font-size: 14px;">
                                          <a href="#" target="_blank" style="font-family: Arial, sans-serif; font-size: 14px; color: #277cbd; text-decoration: none; display: block; width: 100%">Xem</a></td>
                                        <td style="font-size: 14px;"><a href="#" target="_blank" style="font-family: Arial, sans-serif; font-size: 14px; color: #277cbd; text-decoration: none; display: block; width: 100%">Phản hồi</a></td>
                    ...
                    <tr>
                      <td style="font-family: Arial, sans-serif; padding:10px; margin: 0 auto; " class="content-padding">
