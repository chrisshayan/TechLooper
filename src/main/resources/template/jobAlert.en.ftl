                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    <tr>
                      <td align="center" style="padding: 10px 0 5px 0">
                        <h2 style="font-size: 20px; font-weight: 500; padding:0; margin: 0;">Job Alert</h2>
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                    ...
                    <tr>
                      <td align="left" width="100%" style="font-size: 14px;">
                        There are <strong style="font-size: 14px">${numberOfJobs}</strong> job(s) which match your job criteria <strong style="font-size: 14px"><#if keyword??>#${keyword}</#if> <#if location??>#${location}</#if></strong> as follows:
                      </td>
                    </tr>
                    <tr>
