              ...
              <table style="border-collapse: collapse; background:#eee; margin:0 auto" cellpadding="0" cellspacing="0" align="center" border="0" class="deviceWidth" width="100%">
                <tr>
                  <td align="left" style="padding:10px" class="logo">
                    <a href="${webBaseUrl}#/home?utm_source=qualifycontestant&utm_medium=techlooperlogo&utm_campaign=onlinecontest" style="border:none; outline:none" target="_blank">
                  ...
                  <td style="padding:10px" align="right" class="logo">
                    <a href="http://www.vietnamworks.com/?utm_source=qualifycontestant&utm_medium=vietnamworkslogo&utm_campaign=onlinecontest" style="border:none; outline:none" target="_blank">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Chào ${challengeRegistrant.registrantFirstName},</p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <#if challengeRegistrant.activePhase == "REGISTRATION">
                          <#assign localizedCurrentPhase = "Đăng Ký">
                      <#elseif challengeRegistrant.activePhase == "IDEA">
                          <#assign localizedCurrentPhase = "Ý Tưởng">
                      <#elseif challengeRegistrant.activePhase == "UIUX">
                          <#assign localizedCurrentPhase = "UI/UX">
                      <#elseif challengeRegistrant.activePhase == "PROTOTYPE">
                          <#assign localizedCurrentPhase = "Prototype">
                      <#elseif challengeRegistrant.activePhase == "FINAL">
                          <#assign localizedCurrentPhase = "Sản Phẩm Cuối">
                      </#if>
                    <tr>
                      <td align="left" style="margin: 0; padding: 0">
                        <p style="font-size: 14px; line-height: 18px; margin: 0; padding: 0">Bạn đã được chọn vào vòng tiếp theo ${localizedCurrentPhase} của thử thách <a href="${webBaseUrl}#/challenge-detail/${challengeNameAlias}-${challengeId}-id?utm_source=qualifycontestant&utm_medium=clickchallenge&utm_campaign=onlinecontest" style="font-size: 14px; font-weight: 600; color: #277cbd; text-decoration: none" target="_blank">${challengeName}</a>. Xin chúc mừng! Hãy tiếp tục cố gắng để đạt kết quả tốt nhất trong cuộc thi!</p>
                      </td>
                    </tr>
                    <tr>
