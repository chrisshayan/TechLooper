              ...
              <tr>
                <td style="font-family: Arial, sans-serif; padding: 20px; margin: 0 auto; " class="content-padding">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                    ...
                    <tr>
                      <td align="left" width="100%" style="font-size: 14px;">
                        Theo thống kê dữ liệu ngày <strong style="font-size: 16px; font-weight: 500; color:#000000">27/05/2015</strong>, bạn kiếm được nhiều tiền hơn <strong style="font-size: 20px; font-weight: 600; color:#000000">10%</strong> những người giống như bạn.
                      </td>
                    </tr>
                    <tr>
                      <td style="height:20px; line-height: 20px;" width="100%">
                              ...
                              <table border="0" cellspacing="0" cellpadding="0" align="left" style="background:#fff; border-collapse:collapse; margin: 0 auto; padding:0" width="100%">
                                <tr>
                                  <td align="left">
                                    <table border="0" cellspacing="0" cellpadding="0" align="left" style="margin: 0 auto; padding:0" width="100%">
                                      <tr style="color:#555">
                                        <td align="left" style="padding: 10px; width: 35%; padding-left: 15px; font-size: 16px">Phân vị</td>
                                        <td align="left" style="padding: 10px; font-size: 16px">Lương Thực Lãnh (USD/Tháng)</td>
                                      </tr>
                                    </table>
                                  </td>
                                </tr>
                        ...
                        <table width="35%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" class="fullWidth">
                          <tr>
                            <td bgcolor="#277cbd" width="100%" style="padding: 10px 5px; -webkit-border-radius:3px; border-radius:3px; text-align: center">
                              <a href="#" target="_blank" style="font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; display: inline-block;">Xem Ngay</a>
                            </td>
                          </tr>
                        </table>
                      </td>
